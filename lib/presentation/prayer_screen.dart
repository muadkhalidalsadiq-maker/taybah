      ...
      children: [
            ...
            boxShadow: [
              BoxShadow(
                color: (nextPrayer['isBetweenAdhanAndIqama'] == true)
                    ...
                    : TaybahColors.primaryDark.withAlpha(50),
                blurRadius: 16,
        ...
        if (_isLoading)
          ...
          ...prayers.map((p) {
            ...
            final adhanTime12 = PrayerApi.formatTo12Hour(rawTime);
            final iqamaTime12 = key == 'Sunrise'
                ? ''
                : PrayerApi.formatTo12Hour(PrayerApi.getIqamaTime(key, rawTime));
